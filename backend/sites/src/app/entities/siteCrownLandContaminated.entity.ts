...
export class SiteCrownLandContaminated {
  ...
  @OneToMany(
    ...
    (siteContaminationClassXref) => siteContaminationClassXref.sclc,
  )
  ...
  @ManyToOne(
    () => PeopleOrgs,
    (peopleOrgs) => peopleOrgs.siteCrownLandContaminateds,
  )
  ...
  @JoinColumn([
    { name: 'site_crown_land_status_code', referencedColumnName: 'code' },
  ])
