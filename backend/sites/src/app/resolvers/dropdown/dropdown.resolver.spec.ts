...
describe('DropdownResolver', () => {
    ...
    beforeEach(async () => {
        ...
        genericResponseProvider = module.get<GenericResponseProvider<DropdownDto[]>>(GenericResponseProvider);
    });
    ...
    describe('getParticipantRoleCd', () => {
        it('should return participants role codes successfully', async () => {
            ...
            (dropdownService.getParticipantRoleCd as jest.Mock).mockResolvedValueOnce(expectedResult);
            ...
            expect(result.message).toBe('Participants role code fetched successfully');
    ...
    describe('getPeopleOrgsCd', () => {
        it('should return people organizations successfully', async () => {
            const expectedResult: DropdownDto[] = [{ key: '1', value: 'Organization A' }];
            (dropdownService.getPeopleOrgsCd as jest.Mock).mockResolvedValueOnce(expectedResult);
            (genericResponseProvider.createResponse as jest.Mock).mockReturnValueOnce({
