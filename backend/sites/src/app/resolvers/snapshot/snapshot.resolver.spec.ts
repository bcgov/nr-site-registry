...
describe('SnapshotResolver', () => {
    ...
    beforeEach(async () => {
        const module: TestingModule = await Test.createTestingModule({
            providers: [
                ...
                },
                {
                    ...
                    useValue: {
                        createResponse: jest.fn((message: string, httpStatusCode: number, success: boolean, data: Snapshots[]) => ({
                            message,
                            httpStatusCode,
                            success,
                            data,
        ...
        genericResponseProvider = module.get<GenericResponseProvider<Snapshots[]>>(GenericResponseProvider);
    });
    ...
    describe('getSnapshotsByUserId', () => {
        ...
        it('should return a success response with HTTP status 200', async () => {
          ...
          jest.spyOn(service, 'getSnapshotsByUserId').mockResolvedValueOnce(mockResponse.data);
      ...
      describe('getSnapshotsById', () => {
        ...
        it('should return a success response with HTTP status 200', async () => {
          ...
          jest.spyOn(service, 'getSnapshotsById').mockResolvedValueOnce(mockResponse.data);
      ...
      describe('createSnapshot', () => {
        it('should return a success response with HTTP status 201', async () => {
          ...
          jest.spyOn(service, 'createSnapshot').mockResolvedValueOnce(expectedResult);
