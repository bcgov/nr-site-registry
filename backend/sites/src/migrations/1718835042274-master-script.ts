...
export class MasterScript1718835042274 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "sites"."snapshots" ("id" SERIAL NOT NULL, "user_id" character varying(30) NOT NULL, "site_id" bigint NOT NULL, "transaction_id" character varying NOT NULL, "snapshot_data" jsonb NOT NULL, "created" TIMESTAMP NOT NULL DEFAULT now(), "updated" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_f5661b5fd4224d23e26a631986b" PRIMARY KEY ("id"))`);
