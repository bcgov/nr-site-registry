...
export class MasterScript1720160815831 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "sites"."cart" ("who_created" character varying(30) NOT NULL, "who_updated" character varying(30), "whenCreated" TIMESTAMP NOT NULL DEFAULT now(), "whenUpdated" TIMESTAMP NOT NULL DEFAULT now(), "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" character varying(100) NOT NULL, "site_id" bigint NOT NULL, "price" double precision NOT NULL, CONSTRAINT "PK_c524ec48751b9b5bcfbf6e59be7" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "idx_cart_user_id" ON "sites"."cart" ("user_id") `);
        ...
        await queryRunner.query(`ALTER TABLE "sites"."cart" ADD CONSTRAINT "FK_716512915c3949e849a3bdf6fea" FOREIGN KEY ("site_id") REFERENCES "sites"."sites"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "sites"."cart" DROP CONSTRAINT "FK_716512915c3949e849a3bdf6fea"`);
        await queryRunner.query(`DROP INDEX "sites"."spatial_ref_sys_pkey"`);
