...
export class MasterScript1720679499652 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "sites"."folio" DROP CONSTRAINT "PK_14d140998bafd5d7c9db226e5ef"`,
    );
    await queryRunner.query(`ALTER TABLE "sites"."folio" DROP COLUMN "id"`);
    await queryRunner.query(
      `ALTER TABLE "sites"."folio" ADD "id" SERIAL NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "sites"."folio" ADD CONSTRAINT "PK_14d140998bafd5d7c9db226e5ef" PRIMARY KEY ("id")`,
    );
    await queryRunner.query(`DROP INDEX "sites"."idx_folio_id"`);
    await queryRunner.query(
      `ALTER TABLE "sites"."folio_contents" DROP COLUMN "folio_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "sites"."folio_contents" ADD "folio_id" integer NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "sites"."folio_contents" ADD "folio_id" uuid NOT NULL`,
    );
    await queryRunner.query(
      `CREATE INDEX "idx_folio_id" ON "sites"."folio_contents" ("folio_id") `,
    );
    ...
    await queryRunner.query(`ALTER TABLE "sites"."folio" DROP COLUMN "id"`);
    await queryRunner.query(
      `ALTER TABLE "sites"."folio" ADD "id" uuid NOT NULL DEFAULT uuid_generate_v4()`,
    );
    await queryRunner.query(
      `ALTER TABLE "sites"."folio" ADD CONSTRAINT "PK_14d140998bafd5d7c9db226e5ef" PRIMARY KEY ("id")`,
    );
