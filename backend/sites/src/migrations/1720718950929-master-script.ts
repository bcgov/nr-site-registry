...
export class MasterScript1720718950929 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "sites"."folio" DROP COLUMN "folio_content_id"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "sites"."folio" ADD "folio_content_id" character varying(50) NOT NULL`);
    }
