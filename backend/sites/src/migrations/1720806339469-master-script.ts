...
export class MasterScript1720806339469 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "sites"."folio" ADD "folio_id" character varying(100) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "sites"."folio" DROP COLUMN "folio_id"`);
    }
