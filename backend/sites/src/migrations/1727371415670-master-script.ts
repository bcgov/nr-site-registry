...
export class MasterScript1727371415670 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "sites"."subdivisions" ADD "user_action" character varying(30) DEFAULT ''`);
        await queryRunner.query(`ALTER TABLE "sites"."subdivisions" ADD "sr_action" character varying(30) DEFAULT ''`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "sites"."subdivisions" DROP COLUMN "sr_action"`);
        await queryRunner.query(`ALTER TABLE "sites"."subdivisions" DROP COLUMN "user_action"`);
