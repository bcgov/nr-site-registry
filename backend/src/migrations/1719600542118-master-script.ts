...
export class MasterScript1719600542118 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "sites"."recent_views" DROP COLUMN "user_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "sites"."recent_views" ADD "user_id" character varying(100) NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "sites"."recent_views" ADD "user_id" character varying(30) NOT NULL`,
    );
    await queryRunner.query(
      `CREATE INDEX "idx_user_id" ON "sites"."recent_views" ("user_id") `,
    );
