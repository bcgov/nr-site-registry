        ...
        <>
          ...
          <div aria-label="User Account" className="d-md-none">
            ...
            aria-labelledby="user-account-label" onClick={toggleButton}>
                    ...
                    {/* User name */}
                    <div id="user-name" className="p-3">{user.firstname + ' ' + user.lastName}</div>
            ...
            <>
              ...
              <Dropdown aria-label="User Account" className="d-md-flex justify-content-between d-sm-none d-none">
                ...
                <div className="d-flex">
                    <Dropdown.Toggle id="account-dropdown" variant="" className="account-custom-toggle p-0" aria-label="Account Menu" >
                       {/* Profile image */}
                    <div className="d-flex align-items-center " onClick={() => setDropdownArrow(!dropdownArrow)}>
                      <Avatar firstName={user.firstname} lastName={user.lastName} />
                      <div id="account-dropdown" className="ps-2" aria-label="Account Menu Button" >
                        { dropdownArrow ? <DropdownUpIcon/> : <DropdownIcon/> }
                      </div>
                    </div>
                    </Dropdown.Toggle>
                ...
                <Dropdown.Menu className="account-custom-menu" role="menu" aria-labelledby="account-dropdown">
                    ...
                    <Dropdown.Item role="menuitem" className="account-custom-item-first" disabled aria-disabled="true">
                        ...
                        <div className="d-flex align-items-center account-username py-3 ">
                            ...
                            <Avatar firstName={user.firstname} lastName={user.lastName} />
                            {/* User name */}
                            <span className="px-2">{user.firstname + ' ' + user.lastName}</span>
                        </div>
                    </Dropdown.Item>
                    <div className="pt-3">
                      {/* Account settings */}
