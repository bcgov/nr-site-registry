...
import { graphQLNotationClassCd, graphQLNotationParticipantRoleCd, graphQLNotationTypeCd, graphQLParticipantRoleCd, graphQLPeopleOrgsCd } from "../../site/graphql/Dropdowns";
...
export const notationParticipantRoleDrpdown = (state: any) => state.dropdown.dropdowns.notationParticipantRole.getNotationParticipantRoleCd;
export const notationClassDrpdown = (state: any) => state.dropdown.dropdowns.notationClass.getNotationClassCd;
export const notationTypeDrpdown = (state: any) => state.dropdown.dropdowns.notationType.getNotationTypeCd;
export const updatedNotationType = (state: any) => state.dropdown.dropdowns.trackNotationType;
export const updateNotationClass = (state: any) => state.dropdown.dropdowns.trackNotationClass;
