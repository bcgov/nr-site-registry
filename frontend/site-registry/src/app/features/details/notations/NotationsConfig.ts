  ...
  [
    {
      ...
      options: [
        {
          key: '1',
          value: 'CERTIFICATE OF COMPLIANCE ISSUED USING RISK BASED STANDARDS',
        },
  ...
  [
    {
      ...
      options: [
        {
          key: 'CERTIFICATE OF COMPLIANCE ISSUED USING RISK BASED STANDARDS',
          value: 'CERTIFICATE OF COMPLIANCE ISSUED USING RISK BASED STANDARDS',
        },
        {
          key: 'WASTE MANAGEMENT APPROVAL ISSUED',
          value: 'WASTE MANAGEMENT APPROVAL ISSUED',
        },
        {
          key: 'RISK ASSESSMENT SUBMITTED',
          value: 'RISK ASSESSMENT SUBMITTED',
        },
      ],
      value: '',
  ...
  [
    {
      ...
      options: [
        {
          key: 'ENVIRONMENTAL MANAGEMENT ACT: GENERAL',
          value: 'ENVIRONMENTAL MANAGEMENT ACT: GENERAL',
        },
        // { key: 'class2', value: 'Class 2'}
      ],
      value: '',
  ...
  [
    {
      ...
      options: [
        {
          key: 'Bradley Macejkovic',
          value: 'Bradley Macejkovic',
          imageUrl: avatar,
        },
        { key: 'John', value: 'John', imageUrl: avatar },
      ],
