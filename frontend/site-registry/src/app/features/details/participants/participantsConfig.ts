...
export const participantColumnInternal: TableColumn[] = [
    {
        id: 1,
        ...
        displayType: {
            ...
            value:'',
            options: [
                {key:'SHELL CANADA PRODUCTS', value:'SHELL CANADA PRODUCTS'},
                {key:'SNC-LAVALIN ENVIRONMENT INC.', value:'SNC-LAVALIN ENVIRONMENT INC.'},
                {key:'Lorene Rutherford', value:'Lorene Rutherford'},
                {key:'Roland Hintz', value:'Roland Hintz'},
            ],
    ...
    },
    {
      ...
      displayType:{
        ...
        options: [
            ...
            {key:'CASEWORKER', value:'CASEWORKER'},
            {key:'STATUTORY DECISION MAKER', value:'STATUTORY DECISION MAKER'},
        ],
        colSize: "col-lg-6 col-md-6 col-sm-12",
        customLabelCss:'custom-participant-lbl-text',
        customInputTextCss:'custom-participant-input-text',
...
export const participantColumnExternal: TableColumn[] = [
    {
        id: 1,
        displayName:'Participant Name',
        active: true,
...
export const srVisibilityParcticConfig: DropdownItem[] = [
    {
        label:'Show on SR',
