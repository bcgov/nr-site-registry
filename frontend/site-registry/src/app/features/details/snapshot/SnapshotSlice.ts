...
import { createSnapshotForSitesQL, graphQLSnapshotBySiteId } from "../../site/graphql/Snapshot";
    ...
    extraReducers: (builder) => {
        builder
          ...
          .addCase(createSnapshotForSites.fulfilled, (state, action) => {
            ...
            else if(action.payload.data && action.payload.data.createSnapshotForSites.httpStatusCode === ResponseCode.created)
