...
export class Folio {
  ...
  dirty? : boolean = false;
   ...
   constructor( userId:string, folioId:string, description:string, whoCreated:string)
   {
     this.userId = userId;
...
export class FolioContentDTO{
    ...
    constructor( siteId:string, userId:string, folioId:string, id:number, whoCreated:string)
    {
      this.userId = userId;
      this.folioId = folioId;
      this.siteId = siteId;
