...
ssh oraapp@#{dmz_server} 'cd #{test_prod_path}/lto_task/import && sftp -v -b #{test_prod_path}/admin/lto/lto_ftp_cmds siteregistry@#{lto_sftp_site} > /fs/u02/apps_ux/logs/sis/lto_2_sftp.log 2>&1 && rm #{test_prod_path}/lto_task/import/PARCEL_ID_LIST*.TXT'
