export interface INavigationPills {
  ...
  // The 'customNavPillsCss' property is optional and expects a string 
  // that represents custom CSS classes or styles to apply to the main navigation pills component.
  customNavPillsCss?: string;

  // The 'customMobileNavPillsCss' property is optional and expects a string.
  // It is used to apply custom CSS classes specifically when the navigation pills
  // are viewed on mobile devices, supporting responsive design.
  customMobileNavPillsCss?: string;
